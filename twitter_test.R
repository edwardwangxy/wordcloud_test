...
# setup the scraper
consumer_key <- "QeUSZfulRLg6zF2gRoflQXcTG"
consumer_secret <- "O9N2pgzIxOyKmU63jZD1lts55GUF57ieWU9NVWB2LmW7UXarXw"
access_token <- "167424270-XqfLE5sgaXHOgmMnGS0Yk7zczZwkWjYjkQjkncL0"
access_secret <- "TJEURMKVzYH8WpInZpFI9REz9FVk2wwDo0YVR385f7y3s"

setup_twitter_oauth(consumer_key, consumer_secret, access_token, access_secret)
tweets <- searchTwitter("trump", n=5, )
